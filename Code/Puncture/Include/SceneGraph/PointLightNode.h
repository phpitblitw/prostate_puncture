#if !defined (POINT_LIGHT_NODE_H)
#define       POINT_LIGHT_NODE_H

#include "gl\gl.h"
#include "SceneNode.h"
#include "LightNodeData.h"

class AFX_EXT_CLASS PointLightNode : public SceneNode
...
public:
   ...
   ~PointLightNode(void);
	...
	// 获取当前节点的类型
	virtual int  getType(void){ return POINT_LIGHT_NODE; }
