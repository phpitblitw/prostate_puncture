...
namespace fsutility
{
	...
	class AFX_EXT_CLASS StringBuilder { 
		typedef std::basic_string<chr> string_t; 
		typedef std::list<string_t> container_t; // Reasons not to use vector below.  
		typedef typename container_t::const_iterator container_t_itor; // Reasons not to use vector below.  
